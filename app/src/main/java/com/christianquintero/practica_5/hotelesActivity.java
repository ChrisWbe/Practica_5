...
public class hotelesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.menuIzqHoteles);
        ...
        drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, android.R.drawable.ic_menu_report_image, R.string.abierto, R.string.cerradp);
